...
export default function Accueil() {
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col items-center justify-center gap-6 px-4 text-center">
      <Image src="/logo-cnap.jpeg" alt="Commission Nationale Formation" width={280} height={93} priority className="h-auto w-64" />
      ...
      <Link href="/login" className="text-sm font-semibold text-rotary underline">
        Accès organisateurs
      </Link>
    </main>
  );
